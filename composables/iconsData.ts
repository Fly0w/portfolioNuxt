export default function iconsData(): any {
  return {
    bootstrap: {
      ...
      keyPoints: {
        fr: [
          "Grille réactive pour une conception flexible",
          "Composants préconstruits pour une intégration rapide",
          "Large communauté et documentation complète",
        ],
        en: [
          "Responsive grid system for flexible design",
    ...
    css: {
      ...
      keyPoints: {
        fr: [
          ...
          "Conception réactive avec les media queries",
          "Personnalisation avancée grâce aux variables CSS",
        ],
        en: [
    ...
    figma: {
      ...
      keyPoints: {
        fr: [
          "Conception en temps réel avec plusieurs utilisateurs",
          "Compatibilité multiplateforme basée sur le cloud",
          "Outils avancés pour le prototypage et les designs interactifs",
        ],
        en: [
          "Real-time design with multiple users",
    ...
    firebase: {
      ...
      keyPoints: {
        fr: [
          "Base de données temps réel et cloud",
          "Authentification facile avec plusieurs fournisseurs",
          "Hébergement et déploiement simplifiés",
        ],
        en: [
          "Real-time and cloud database",
    ...
    gitHub: {
      ...
      keyPoints: {
        fr: [
          ...
          "Gestion efficace des versions avec Git",
        ],
        en: [
    ...
    html: {
      ...
      keyPoints: {
        fr: [
          "Élément fondamental pour tous les sites web",
          "Compatibilité avec CSS et JavaScript",
          "Extensions avec des API modernes comme Web Components",
        ],
        en: [
          "Fundamental element for all websites",
    ...
    javascript: {
      ...
      keyPoints: {
        fr: [
          ...
          "Écosystème riche avec des frameworks populaires",
          "Support des technologies modernes comme WebSockets",
        ],
        en: [
    ...
    laravel: {
      ...
      keyPoints: {
        fr: [
          ...
          "ORM puissant avec Eloquent",
          "Support natif des tâches programmées avec Scheduler",
        ],
        en: [
    ...
    mongoDB: {
      ...
      keyPoints: {
        fr: [
          "Stockage flexible pour des données complexes",
          "Requêtes puissantes avec une syntaxe simple",
          "Évolutivité horizontale pour les grandes applications",
        ],
        en: [
    ...
    nextJS: {
      ...
      keyPoints: {
        fr: [
          "Rendu côté serveur et statique",
          "Routage intégré",
    ...
    nuxt: {
      ...
      keyPoints: {
        fr: [
          ...
          "Support des plugins et middlewares",
          "Expérience développeur optimisée avec des outils intégrés",
        ],
        en: [
    ...
    reactJS: {
      ...
      keyPoints: {
        fr: [
          "Rendu basé sur des composants",
          "Support de la gestion d'état avancée avec Redux",
    ...
    tailwindCSS: {
      ...
      keyPoints: {
        fr: [
          "Classes utilitaires flexibles",
          "Personnalisation rapide",
          "Compatible avec n'importe quel design",
        ],
        en: [
    ...
    typescript: {
      ...
      keyPoints: {
        fr: [
          ...
          "Interopérabilité complète avec JavaScript",
          "Supporté par les principaux éditeurs de code",
        ],
        en: [
          "Static typing to prevent errors",
    ...
    vueJS: {
      ...
      keyPoints: {
        fr: [
          ...
          "Ecosystème flexible pour grands et petits projets",
          "Support de bibliothèques comme Vuex pour la gestion d'état",
        ],
        en: [
    ...
    vuetify: {
      ...
      keyPoints: {
        fr: [
          "Composants basés sur le Material Design",
          "Personnalisation simple grâce à des thèmes",
    ...
    postgreSQL: {
      ...
      keyPoints: {
        fr: [
          ...
          "Grande capacité de gestion des données",
        ],
        en: [
          "High reliability",
    ...
    remix: {
      ...
      keyPoints: {
        fr: [
          "Rendu côté serveur (SSR) pour des performances accrues",
          "Gestion intuitive des routes et des données",
          "Adapté aux applications modernes avec des outils optimisés",
        ],
        en: [
